...
public class DoctorGrpcService : DoctorService.DoctorServiceBase
{
    ...
    public override async Task<GetDoctorsResponse> GetDoctors(GetDoctorsRequest request, ServerCallContext context)
    {
        ...
        catch (Exception ex)
        {
            ...
            throw new Exception("Error retrieving doctors");
        }
    }
        ...
        ServerCallContext context)
    {
        ...
        catch (Exception ex)
        {
            ...
            throw new Exception("Error retrieving doctor");
        }
    }
        ...
        ServerCallContext context)
    {
        ...
        catch (Exception ex)
        {
            ...
            throw new Exception("Error retrieving available doctors");
        }
    }
        ...
        ServerCallContext context)
    {
        ...
        catch (Exception ex)
        {
            ...
            throw new Exception("Error retrieving doctor schedules");
        }
    }
