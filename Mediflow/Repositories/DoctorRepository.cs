    ...
    public async Task<IEnumerable<DoctorDto>> GetDoctorsBySpecializationAsync(string specialization)
    {
        try
        {
            ...
            var doctors = await _context.Doctors
                .Where(d => d.Specialization.ToLower().Contains(specialization) && d.IsActive)
        ...
        DateTime toDate)
    {
        try
        {
            ...
            var bookedDates = _context.Appointments
                ...
                .Select(a => a.AppointmentDate.AddHours(5).AddMinutes(45))
                .ToList();
            ...
            var schedules = await _context.Schedules
                .Include(s => s.TimeSlots.Where(ts =>
                    ...
                    ts.StartTime <= toDate &&
                    !bookedDates.Contains(ts.StartTime))) // Exclude booked times
